...
DATA = BASE / "landmark_data_random_split"  # Use fallback data
TRAIN_SCRIPT = BASE / "train_landmark_transformer.py"
OUTPUT_DIR = BASE / "outputs" / "landmark_transformer_common_v1"
PRETRAINED = BASE / "outputs" / "landmark_transformer_3d_v2" / "best_model.pth"
...
print("\n" + "="*60)
print("Starting training — target: 90-95%+ validation accuracy")
